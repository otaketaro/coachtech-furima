    ...
    <main class="pfx">
        ...
        <form class="pfx__form" method="POST" action="{{ route('purchase.address.update', $item) }}">
            ...
            <div class="pfx__group">
                ...
                <input id="shipping_postal_code" name="shipping_postal_code" type="text" class="pfx__input"
                    value="{{ old('shipping_postal_code', $user->postal_code) }}" placeholder="例）123-4567">
            ...
            <div class="pfx__group">
                ...
                <input id="shipping_address" name="shipping_address" type="text" class="pfx__input"
                    value="{{ old('shipping_address', $user->address) }}" placeholder="都道府県・市区町村・番地など">
            ...
            <div class="pfx__group">
                ...
                <input id="shipping_building" name="shipping_building" type="text" class="pfx__input"
                    value="{{ old('shipping_building', $user->building) }}" placeholder="建物名・部屋番号など（任意）">
